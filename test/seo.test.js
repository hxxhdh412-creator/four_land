...
test('SSR page contains indexable SEO and content',()=>{const html=renderPropertyPage(sample);assert.match(html,/<link rel="canonical" href="https:\/\/www\.fourland\.vn\/bat-dong-san\//);assert.match(html,/<h1>160\/34\/13 Phan Huy Ích<\/h1>/);assert.match(html,/application\/ld\+json/);assert.match(html,/og:image/)});
